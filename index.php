                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                <span data-animation="fadeInLeft" data-delay="0.1s">WELCOME TO AAMS </span>
                                <h1 data-animation="fadeInLeft" data-delay="0.4s">GYM CENTRE</h1>
